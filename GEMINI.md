...
- **Очищення невикористовуваних стилів:** Якщо видаляється JSX/TSX розмітка, обов'язково перевіряти та видаляти відповідні невикористовувані CSS/SCSS стилі та класи.
...
- **Перевірка API серверу**: при виконанні завдань з API обов'язково перевіряти реальні відповіді бекенду шляхом надсилання запитів (через тестові скрипти чи cURL), а не покладатися лише на припущення.
...
## Тестові дані (Авторизація)

Тестовий акаунт для розробки та перевірки авторизації:

- **Телефон / Логін**: `093 794 5751`
- **Пароль**: `112231qwaszX`
...
- ❌ Залишати невикористовувані CSS/SCSS стилі при видаленні JSX/TSX розмітки.
