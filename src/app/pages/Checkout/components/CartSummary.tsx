                        ...
                        <div key={item.rowId || item.id} className={s.cartItem}>
                            ...
                            <div className={s.cartItemRight}>
                                {item.product.originalPrice > item.product.price ? (
                                    <>
                                        <span className={clsx(s.cartItemPrice, s.cartItemPriceDiscount)}>{item.product.price * item.quantity} <span className={s.currency}>₴</span></span>
                                        <span className={s.cartItemPriceOriginal}>{item.product.originalPrice * item.quantity} <span className={s.currency}>₴</span></span>
                                    </>
                                ) : (
                                    <span className={s.cartItemPrice}>{item.product.price * item.quantity} <span className={s.currency}>₴</span></span>
                                )}
                    ...
                    <div className={s.cartStats}>
                        {typeof cashback === 'number' && (
                            <div className={s.cartStat}>
                                ...
                                <span className={s.cartStatVal}>{cashback} <span className={s.currencyLG}>Б</span></span>
                            </div>
                        )}
