...
export default function BlogPostPage({ dict, post, lang }: BlogPostPageProps) {
    ...
    const handleLike = async () => {
        ...
        const result = await likeBlogApi(post.id);
        if (result) {
