...
import s from './DeletePickupModal.module.scss';
...
const dict = {
    ua: {
        ...
        message: "Ви впевнені, що хочете видалити цей заклад?",
        confirm: "Видалити",
        cancel: "Скасувати"
    },
    ru: {
        title: "Удаление заведения",
        message: "Вы уверены, что хотите удалить это заведение?",
        confirm: "Удалить",
        cancel: "Отменить"
    }
};

export default function DeletePickupModal({ isOpen, onClose, onConfirm, lang }: DeletePickupModalProps) {
