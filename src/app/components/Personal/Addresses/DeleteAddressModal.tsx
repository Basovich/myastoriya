...
import s from './DeleteAddressModal.module.scss';
...
export default function DeleteAddressModal({ isOpen, onClose, onConfirm, lang }: DeleteAddressModalProps) {
