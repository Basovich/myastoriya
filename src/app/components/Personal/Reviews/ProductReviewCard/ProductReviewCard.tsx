    ...
    return (
        <div className={s.card}>
            <div className={s.header}>
                <div>
                    {hasReview && typeof published === 'boolean' && (
                        published ? (
                            <span className={clsx(s.badge, s.badgePublished)}>
                                {lang === 'ru' ? 'Опубликовано' : 'Опубліковано'}
                            </span>
                        ) : (
                            <span className={clsx(s.badge, s.badgeModeration)}>
                                {lang === 'ru' ? 'На модерации' : 'На модерації'}
                            </span>
                        )
                    )}
                </div>
