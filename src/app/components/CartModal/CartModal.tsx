...
export default function CartModal({ isOpen, onClose, isCheckoutMode = false }: CartModalProps) {
    ...
    return (
        <Modal
            ...
            closeTimeoutMS={200}
        >
            <button className={s.closeBtn} onClick={onClose} aria-label={lang === 'ru' ? 'Закрыть корзину' : 'Закрити кошик'}>
                ...
                {removedItems.length > 0 ? (
                    ...
                    {loading ? (
                        ...
                        <div className={s.emptyState}>
                            {lang === 'ru' ? 'Ваша корзина пуста.' : 'Ваш кошик порожній.'}
                        </div>
                    ) : (
                        <div className={s.cartItems}>
                                        ...
                                        <div className={s.itemBottom}>
                                            ...
                                            <div className={s.itemPriceBlock}>
                                                ...
                                                <button
                                                    ...
                                                    aria-label={lang === 'ru' ? 'Удалить товар' : 'Видалити товар'}
                                                >
                            ...
                            <div className={s.summaryStats}>
                                ...
                                <div className={s.statRow}>
                                    <div className={s.statLabel}>
                                        ...
                                        <span>{lang === 'ru' ? 'Общая сумма:' : 'Загальна сума:'}</span>
                                    </div>
                        ...
                        {suggestedProducts.length > 0 && (
                            <div className={s.suggestedBlock}>
                                <div className={s.suggestedHeader}>
                                    <h3 className={s.suggestedTitle}>{lang === 'ru' ? 'Вместе дешевле' : 'Разом дешевше'}</h3>
                                </div>
