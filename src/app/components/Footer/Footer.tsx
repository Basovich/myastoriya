    ...
    return (
        <footer className={s.footer} id="footer">
                        ...
                        <div className={s.appButtons}>
                            <a href={footer.appLinks.googlePlay} className={s.storeBtn}>
                                <div>
                                    ...
                                    <Image className={s.storeIcon} src="/icons/google_play.svg" alt="Google Play" width={130} height={26} />
                                </div>
                            </a>
                            <a href={footer.appLinks.appStore} className={s.storeBtn}>
                                <div>
                                    <span className={s.storeSub}>Скачати в</span>
                                    <Image className={s.storeIcon} src="/icons/apple_store.svg" alt="Apple Store" width={124} height={28} />
                                </div>
                            </a>
                        </div>
                    </div>
            ...
            <div className={s.copyright}>
                <p>© {new Date().getFullYear()} М'ЯСТОРІЯ. Всі права захищені.</p>
            </div>
        </footer>
    );
}
